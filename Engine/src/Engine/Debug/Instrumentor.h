...
#define EG_PROFILE 0
	...
	#define EG_PROFILE_SCOPE(name) ::Engine::InstrumentationTimer timer##__LINE__(name);//__LINE__表示当前代码所在行数
	#define EG_PROFILE_FUNCTION() EG_PROFILE_SCOPE(__FUNCSIG__) //__FUNCTION__函数名称,__FUNSIG__转译函数的签名比如对于int test(int x),__FUNCSIG__:int __cdecl test(int)
#else
