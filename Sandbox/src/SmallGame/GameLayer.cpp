...
void GameLayer::OnEvent(Engine::Event& e)
{
	...
	dispatcher.Dispatch<WindowResizedEvent>(EG_BIND_EVENT_FN(GameLayer::OnWindowResize));
	dispatcher.Dispatch<MouseButtonPressedEvent>(EG_BIND_EVENT_FN(GameLayer::OnMouseButtonPressed));
}
...
bool GameLayer::OnWindowResize(Engine::WindowResizedEvent& e)
{
